...
(function() {
    ...
    function login() {
        ...
        if (!email) {
            loginError.textContent = 'Please enter an email.';
            return;
        }
        if (!pass) {
    ...
    function guestLogin() {
        loginUser('guest_' + Date.now() + '@guest.com');
    }
    ...
    function checkSession() {
        ...
        if (saved) {
            try {
                ...
                loginOverlay.classList.add('hidden');
                app.classList.remove('hidden');
                userBadge.textContent = data.displayName;
                currentUser = data;
                if (data.displayName === 'Iceback' || data.email === 'demo@safari.ai') {
                    isOwner = true;
                }
                return true;
