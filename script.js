// ================================================================
// SAFARI AI – COMPLETE SCRIPT (FIXED – ALWAYS REPLIES)
...
(function() {
    ...
    function parseMarkdown(text) {
        ...
        html = html.replace(/```([\s\S]*?)```/g, function(m, c) {
            return `<pre style="background:rgba(0,0,0,0.05);padding:10px;border-radius:8px;overflow-x:auto;font-family:monospace;font-size:13px;">${c}</pre>`;
        });
    ...
    // ===== SEND CHAT MESSAGE (GUARANTEED REPLY) =====
        ...
        try {
            ...
            if (!apiSuccess || !reply) {
                ...
                if (lowerText.includes('joke')) {
                    ...
                    reply =
                        `🤔 I'm Safari AI. I can help with: <br />• "weather London" (get weather)<br />• "safari search Einstein" (search Wikipedia)<br />• "who is your owner" (about me)<br />• "channel link" (join WhatsApp)<br />• "generate image of a cat" (AI art)<br />• "tell me a joke"<br />• "football today"<br /><br /><strong>⚡ POWERED BY ICEBACK MASTER TECH</strong>`;
                } else {
                    // Default fallback for any other question
                    reply =
                        `🤔 I'm Safari AI, created by ICEBACK MASTER TECH. I'm here to help! Try asking me about weather, search, jokes, or just chat with me. I'm learning every day! 😊<br /><br /><strong>⚡ POWERED BY ICEBACK MASTER TECH</strong>`;
                }
            }
    ...
    function login() {
        ...
        const email = emailInput ? emailInput.value.trim() : 'demo@safari.ai';
        const pass = passInput ? passInput.value.trim() : 'password123';
